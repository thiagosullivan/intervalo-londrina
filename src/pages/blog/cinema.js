...
function Cinema({ posts }) {

  const filterdCategory = posts.filter(posts => posts.node.category.name == 'Cinema')

  console.log(filterdCategory, "filtrados")

  return (
    <div id="homepage">
      <Head>
        <title>Cinema | Intervalo Londrina</title>
