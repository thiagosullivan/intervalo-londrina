...
function Literatura({ postagens }) {

  const [showResults, setShowResults ] = useState(postagens)

  const filterdCategory = postagens.filter(posts => posts.category == 'Literatura')
